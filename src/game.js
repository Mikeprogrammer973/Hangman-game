...
function check_letter(){
  ...
  //alert(search)
  while(search != null){
    c_word.children[w.indexOf(i_letter.value)].innerHTML = i_letter.value.toUpperCase()
...
function take_word(){
  ...
  //Dica
    ...
    alrd_ok.push(word[0])
    c_word.children[word.length-1].innerHTML = word[word.length-1].toUpperCase()
...
function fill_time_bar(){
  ...
  document.getElementById("time-bar").children[0].style.width = `${width/10}%`
